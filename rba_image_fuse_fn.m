function rba_image = rba_image_fuse_fn( inp_wt, Nlevels,idx_x, idx_y, m, n )
    ...
    %   Nlevels, image wavelet decomposition level
    %   idx_x, idx_y, m, n: start row and column index of the region in low frequency subband
    %   m, n: row and column length for the region
    % Output:
    %   rba_image: cell object storing region based activity level of all images to be fused
