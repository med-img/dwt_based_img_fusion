function mean_windowed = windowed_centered_mean(mat, m, n, zero_pad)
    ...
    % Input:
    %   mat: matrix for compute windowed mean
    %   m, n: length and width size of the window;
    %   zero_pad: logical, whether to use zero padding or periodical boundary conditioins for input mat
    % Output:
    %   mean_windowed: computed mean value over a window m x n, centered at position p(i,j)
